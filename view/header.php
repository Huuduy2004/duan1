...
<!-- Mirrored from creativelayers.net/themes/techno-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Nov 2023 10:41:09 GMT -->
<head>
	<!-- Basic Page Needs -->
	<meta charset="UTF-8">
	...
	<!-- Boostrap style -->
	<link rel="stylesheet" type="text/css" href="creativelayers.net/themes/techno-html/stylesheets/bootstrap.min.css?ver=<?= rand() ?>">

	<!-- Theme style -->
	<link rel="stylesheet" type="text/css" href="creativelayers.net/themes/techno-html/stylesheets/style.css?ver=<?= rand() ?>">

	<!-- Reponsive -->
	<link rel="stylesheet" type="text/css" href="creativelayers.net/themes/techno-html/stylesheets/responsive.css?ver=<?= rand() ?>">
	...
	<link rel="shortcut icon" href="creativelayers.net/themes/techno-html/images/logos/logodpn.jpg">
						...
						<div class="col-md-3">
							<div id="logo" class="logo">
								<a href="index.html" title="">
									<img src="creativelayers.net/themes/techno-html/images/logos/logodpn.jpg" alt="">
								</a>
							</div><!-- /#logo -->
						</div><!-- /.col-md-3 -->
						<div class="col-md-6">
